...
public class QueryExecutionBuilder_Orig {
    ...
    public static QueryExecutionBuilder_Orig create() {
        return new QueryExecutionBuilder_Orig();
    }

    private QueryExecutionBuilder_Orig() {}

    public QueryExecutionBuilder_Orig query(Query query) {
        this.query = query;
        return this;
    }

    public QueryExecutionBuilder_Orig dataset(DatasetGraph dsg) {
        this.dataset = dsg;
        return this;
    }

    public QueryExecutionBuilder_Orig context(Context context) {
        this.context = context;
        return this;
    }

    public QueryExecutionBuilder_Orig initialBinding(Binding binding) {
    ...
    public QueryExecution build() {
        ...
        if ( f == null ) {
            Log.warn(QueryExecutionBuilder_Orig.class, "Failed to find a QueryEngineFactory");
            return null;
        }
